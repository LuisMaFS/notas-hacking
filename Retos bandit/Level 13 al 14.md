...
SE obtuvo la llave SSH desde la terminal de reto bandit14. Después la guardamos en un archivo txt. Después iniciamos sesión con esa llave a bandit14. 
Ingresamos cat /etc/bandit_pass/bandit14 y obtenemos la llave.
