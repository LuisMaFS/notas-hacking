...
**Conectarse por medio de netcat al la siguiente ruta** `nc jupiter.challenges.picoctf.org 5726`.

**Muestra un mensaje cifrado**
Encrypted message:
...
**Usando un decodificador Vigènere**
**Usando la llave flag, obtenemos la bandera**
